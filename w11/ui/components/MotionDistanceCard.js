                ...
                <md-ripple>
                    ...
                    <div class="md-layout md-gutter md-alignment-center-left">
                        ...
                        <div class="md-layout-item md-layout">
                            <md-content class="md-subheading md-layout-item md-size-5 md-xsmall-hide">0</md-content>
                            <md-progress-bar class="md-primary md-layout-item md-elevation-8 md-xsmall-size-95"
                                md-mode="determinate"
                                :md-value="distance * 100"></md-progress-bar>
                            <md-tooltip md-direction="top">
                                <span class="md-caption md-subheading tooltip">{{ distance.toFixed(1) }}</span>
                            </md-tooltip>
                            <md-content class="md-subheading md-layout-item md-size-5 md-xsmall-hide">1m</md-content>
                        </div>
                    </div>
                </md-ripple>
            </md-card>
